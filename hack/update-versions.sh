...
echo "ALINAS_UTILS_RPM_BASE_URL: ${ALINAS_UTILS_RPM_BASE_URL}"
echo ""
...
ALINAS_UTILS_RPM_BASE_URL_ESC=$(escape_sed "${ALINAS_UTILS_RPM_BASE_URL}")
...
sed -i '' "s|^ARG ALINAS_UTILS_RPM_BASE_URL=.*|ARG ALINAS_UTILS_RPM_BASE_URL=${ALINAS_UTILS_RPM_BASE_URL_ESC}|" "${MOUNT_PROXY_DOCKERFILE}"
